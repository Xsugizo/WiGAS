...
# adb shell bmgr enable false (enable backup)
# os.system('adb -s '+ i +' shell bmgr enable true') # set enable backup

# # adb shell settings put global stay_on_while_plugged_in 3 (set stay awake to true )
# os.system('adb -s '+ i +' shell settings put global stay_on_while_plugged_in 3 ') # set stay awake to true 

# adb shell settings put global development_settings_enabled 1 (enable Developer options)
# os.system('adb -s '+ i +' shell settings put global development_settings_enabled 1 ') # enable Developer options
...
file_path = "/home/"+UsrName+"/Desktop/IMAGE/workspace/Pipeline_Testing/android-cts-media-1.5/"
