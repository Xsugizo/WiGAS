...
def test():
    ...
    path = dirpath+"/android-gts/tools"
    ...
    def save_and_read():
        ...
        test_image =[]
        test_devices = []
        output = os.popen('./gts-tradefed l r').read()
        ...
        with open('test_file.csv','r')as file_obj:
            ...
            for lines in reader_obj:
                ...
                try:
                    ...
                    test = lines[0]+" "+lines[1]+" "+lines[2]+" "+lines[length-3]+" "+lines[length-2]
                    print(test)
                    # if(lines[11]==""):
                    if(lines[length-3]==""):
                        #print("image error")
        ...
        #print("l r Saving...") 
        return test_session,test_fail,test_image,test_devices,test_pass
    ...
    session,test_fail,test_image,test_devices,test_pass = save_and_read()
    ...
    t_count,p_count,f_count,s_num = counting(test_image,test_devices,test_fail,session,test_pass)
